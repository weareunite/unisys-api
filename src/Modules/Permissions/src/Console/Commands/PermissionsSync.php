...
namespace Unite\UnisysApi\Modules\Permissions\Commands;
...
class PermissionsSync extends Command
{
     ...
     * @var string
     */
    protected $signature = 'unisys-api:permissions:sync-permissions';
    ...
    public function handle()
    {
        ...
        $global = Permission::getGlobalPermissions();
